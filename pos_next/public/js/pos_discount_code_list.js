...
frappe.listview_settings["POS Discount Confirmation Code"] = {
	onload(listview) {
		if (!frappe.model.can_create("POS Discount Confirmation Code")) return;

		listview.page.add_inner_button(__("Generate Codes"), () => {
			frappe.prompt(
				[
					{
						fieldname: "count",
