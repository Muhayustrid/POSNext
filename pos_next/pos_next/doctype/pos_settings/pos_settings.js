...
frappe.ui.form.on("POS Settings", {
	refresh(frm) {
		...
		// The global settings (invoice type, target bases, negative stock,
		// languages) moved to their own single doctype.
		frm.add_custom_button(__("Global Settings"), () =>
			frappe.set_route("Form", "POS Next Global Settings")
		);
	},
